...
namespace TUCAMAPI
{
    ...
    * **************************************************************** */
    ...
    public struct TUCAM_BIN_ATTR
    {
	    ...
	    public Int32 nMode;                              // [in/out] The any bin mode
        public Int32 nWidth;                             // [in/out] The any bin width
        public Int32 nHeight;                            // [in/out] The any bin height
    };
    ...
    public class TUCamAPI
    {
        ...
        [DllImport("TUCam.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern TUCAMRET TUCAM_Prop_SetValue(IntPtr hTUCam, Int32 nProp, Double dbval, Int32 nChn = 0);
        ...
        [DllImport("TUCam.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern TUCAMRET TUCAM_Buf_WaitForFrame(IntPtr hTUCam, ref TUCAM_FRAME pFrame, Int32 nTimeOut = 1000);
        ...
        // Get GrayValue
        [DllImport("TUCam.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern TUCAMRET TUCAM_Get_GrayValue(IntPtr hTUCam, Int32 nXPos, Int32 nYPos, ref Int16 pusValue);


        // Find color temperature index value according to RGB
        [DllImport("TUCam.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern TUCAMRET TUCAM_Index_GetColorTemperature(IntPtr hTUCam, Int32 nRed, Int32 nGeen, Int32 nBlue, ref Int32 pusValue);
